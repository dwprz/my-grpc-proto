...
import (
	transaction "github.com/dwprz/my-grpc-proto/protogen/go/transaction"
...
type PaymentRequest struct {
	...
	TotalAmount uint64            `protobuf:"varint,3,opt,name=total_amount,proto3" json:"total_amount,omitempty"`
...
func (x *PaymentRequest) GetTotalAmount() uint64 {
	if x != nil {
...
func (x *PaymentRequest) GetTax() float64 {
	if x != nil {
		return x.Tax
	}
	return 0
...
var file_proto_payment_payment_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6c, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04,
	...
	0x63, 0x6f, 0x6d, 0x2f, 0x64, 0x77, 0x70, 0x72, 0x7a, 0x2f, 0x6d, 0x79, 0x2d, 0x67, 0x72, 0x70,
